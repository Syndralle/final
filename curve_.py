...
# plot_curve(datas, 'epoch', ['metrics/mAP50(B)'], 'mAP50 over epochs', 'epoch', 'mAP50(%)', [280, 300, 0.95, 0.985], ['lower right', 'center'], 'v8n_map50.png')
# plot_curve(datas, 'epoch', ['metrics/mAP50-95(B)'], 'mAP50-95 over epochs', 'epoch', 'mAP50-95', [280, 300, 0.68, 0.74], ['lower right', 'center'], 'v8n_map50_95.png')
...
plot_curve(datas, 'epoch', ['metrics/mAP50(B)'], 'mAP50 over epochs', 'epoch', 'mAP50(%)', [280, 300, 0.95, 0.985], ['lower right', 'center'], 'ablation_map50.png', False, 50)
plot_curve(datas, 'epoch', ['metrics/mAP50-95(B)'], 'mAP50-95 over epochs', 'epoch', 'mAP50-95', [280, 300, 0.68, 0.74], ['lower right', 'center'], 'ablation_map50_95.png', False, 50)
